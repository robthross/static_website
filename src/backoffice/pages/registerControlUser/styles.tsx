...
interface StyledHalfContainerProps {
  leftPadding?: boolean
}
...
export const HalfContainer = styled.div<StyledHalfContainerProps>`
  width: 50%;
  padding-left: ${({ leftPadding }) => (leftPadding ? '16px' : 0)};
  padding-right: ${({ leftPadding }) => (!leftPadding ? '16px' : 0)};
`
