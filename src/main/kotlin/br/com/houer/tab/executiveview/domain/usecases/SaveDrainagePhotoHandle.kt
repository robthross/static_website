...
@Singleton
class SaveDrainagePhotoHandle(private val downloadAndSaveMediaUseCase: DownloadAndSaveMediaUseCase) :
    BaseInspectionReportHandler() {

    override fun handleReport(report: InspectionReport) {
        val drainagePhotoURL = report.drainagePhoto?.let {
        ...
        super.handleReport(report.copy(drainagePhoto = drainagePhotoURL))
    }
}
